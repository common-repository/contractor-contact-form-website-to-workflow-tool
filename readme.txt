...
= Service =
Customer Management Service through the plugin for Leap.

== Changelog ==

= 4.3.0 =
1. Validate the access token
2. Correct the typo in logout method (from Delete to DELETE)
3. At the time of disconnect, remove the unwanted headers

= 4.2.0 =
1. Escaping variables with dynamic values
2. Changed client secret variables

= 4.1.0 =
1. Security Patch for XSS
2. Tested upto WordPress 6.3

= 4.0.0 =
1. Branding change to Leap

= 3.0.10 =
1. Tested upto WordPress 6.1
